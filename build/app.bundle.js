...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    key: 'displayBiography',
    value: function displayBiography(profile) {
      var _this = this;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ui.ui.clearCurrent();
            _context.next = 3;
            return document.querySelector('#entry').value.trim();

          case 3:
            searchTerm = _context.sent;
...
var _ui = __webpack_require__(130);
